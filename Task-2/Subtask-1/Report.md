...
<p align="center">
	<img src="_road_thickness_distribution.png" alt="road_thickness_distribution" style="width:60%; height:auto;">
</p>

2. Average Road Mask Density - Calculated by getting the fraction of non-zero pixels in the mask, divided by `Height x Width`.
<p align="center">
	<img src="_average_road_density_distribution.png" alt="average_road_density_distribution" style="width:60%; height:auto;">
</p>
...
<p align="center">
	<img src="Pasted image 20260624191259.png" alt="average_road_density_distribution" style="width:60%; height:auto;">
</p>
...
**<u>Training Loss:</u>**
<p align="center">
	<img src="classicunet_model_loss_ 1.png" alt="Training Loss History" style="width:50%; height:auto;">
</p>

**<u>Evaluation and Inference:</u>**
<p align="center">
Average IoU score = 0.1789 | Average Dice score = 0.2874
	<img src="classicunet_model_predictions.png" alt="classicunet_model_predictions" style="width:60%; height:auto;">
</p>
...
<p align="center">
	<img src="Pasted image 20260624193044.png" alt="attention gate diagram" style="width:60%; height:auto;">
</p>
...
<u>Training Loss:</u>
<p align="center">
	<img src="attendedunet_model_loss_ 1.png" alt="attendedunet_model_loss_" style="width:60%; height:auto;">
</p>

**<u>Evaluation and Inference:</u>**
<p align="center">
Average IoU score = 0.1708 | Average Dice score = 0.2803
	<img src="attendedunet_model_predictions.png" alt="attendedunet_model_predictions" style="width:60%; height:auto;">
</p>
...
<p align="center">
	<img src="Pasted image 20260624205508.png" alt="resnetunet" style="width:60%; height:auto;">
</p>
\**The above diagram is accurate upto the last step, where I did not do another double convolution for 512-->1024*
**<u>Training Loss:</u>**
<p align="center">
	<img src="resnetunetFOCALLoss_model_loss_.png" alt="resnetunet_loss" style="width:60%; height:auto;">
</p>

**<u>Evaluation and Inference:</u>**
<p align="center">
Average IoU score = 0.3025 | Average Dice score = 0.456
	<img src="resnetunet_model_predictions.png" alt="attendedunet_model_predictions" style="width:60%; height:auto;">
</p>
...
**<u>Training Loss:</u>
<p align="center">
	<img src="resnetattendedunet_model_loss_.png" alt="resnetunet" style="width:60%; height:auto;">
</p>

**<u>Evaluation and Inference:</u>
<p align="center">
Average IoU score = 0.1926 | Average Dice score = 0.3148
	<img src="resnetattendedunet_model_predictions.png" alt="resnetattendedunet_model_predictions" style="width:60%; height:auto;">
</p>
...
<p align="center">
	<img src="Pasted image 20260624222644.png" alt="segformer_architecture" style="width:70%; height:auto;">
</p>
...
**<u>Training Loss:</u>
<div align="center"> <table> <tr> <td align="center"><b>SegFormer (Pretrained)</b></td> <td align="center"><b>SegFormer (Scratch)</b></td> </tr> <tr> <td><img src="segformer_model_loss_.png" width="340"/></td> <td><img src="scratchsegformer_model_loss_.png" width="340"/></td> </tr> </table> </div> 
...
<tr> 
<td><img src="segformer_model_predictions.png" width="340"/></td>
<td><img src="scratchsegformer_model_predictions.png" width="340"/></td>
</tr> 
</table> 
</div>
## <u>Experiments</u>
...
<tr> 
<td><img src="resnetunetBCELoss_model_predictions.png" width="340"/></td>
<td><img src="resnetunetDICELoss_model_predictions.png" width="340"/></td>
</tr> 
</table> 
</div>
<div align="center">
...
<tr> 
<td><img src="resnetunetBCE-DICELoss_model_predictions.png" width="340"/></td>
<td><img src="resnetunet_model_predictions 1.png" width="340"/></td>
</tr> 
</table> 
</div>
<div align="center">
